# -MNIST-
#Built a handwritten digit classification model using PyTorch on the MNIST dataset, demonstrating end-to-end deep learning workflow including preprocessing, training,  #and evaluation
...
torch.save(model.state_dict(), 'minst_model.path')
print('model saved as minst_model.pth')

index = 0
image, true_label = test_data[index]

plt.show(image.squeeze(), cmap='gray')
